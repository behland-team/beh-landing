...
export default function Footer() {
  ...
  return (
    <footer dir="rtl" className="grid  grid-cols-1 md:grid-cols-2  lg:grid-cols-3 lg:grid-rows-2 gap-7 lg:gap-5 items-start bg-gradient-to-b  from-[#54E2D9]  to-white px-6 py-12  md:px-10 lg:px-16 xl:px-24 lg:py-16 ">
      ...
      <div className="grid col-span-1  w-full lg:row-span-full ">
        ...
        <div className="col-span-1  lg:row-span-1  flex items-center flex-col justify-center gap-2 lg:justify-start">
      ...
      <div className="col-span-1 row-start-2  lg:row-start-2 lg:row-span-1 space-y-1 ">
        ...
        <div className="flex items-center justify-between  w-full rounded-xl overflow-hidden   border border-gray-500 ">
          <input
            ...
            className="rounded-full border-0 bg-transparent outline-none w-full h-full mx-1 placeholder:text-sm"
          />
          <button className="rounded-lg border-2 text-cream-medium border-cream-medium px-6 text-sm p-1 m-0.5 bg-cream-dark_light ">
            ارسال
          </button>
        </div>
      </div>
