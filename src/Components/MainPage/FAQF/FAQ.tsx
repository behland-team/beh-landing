        ...
        <div className="overflow-hidden">
            <div className="relative h-[200px] max-w-[440px] ml-auto md:hidden">
                ...
                <Image src={board} alt={"board"}
                       className="absolute h-28  xxs:h-[130px] left-1/2 -translate-x-1/2 top-16 xxs:top-20 -z-10"/>
                <div
                    className="absolute top-28 xxs:top-32 z-10 text-xl xxs:text-4xl text-center w-fit left-1/2 -translate-x-1/2 text-white font-bold flex items-center gap-2">
                    <span className="icon icon-navigate xxs:text-lg"></span>
                    <p>{t("FAQ")}</p>
                </div>
            </div>
            <div dir="rtl" className=" w-full  mt-10  md:px-10 lg:px-20  relative ">
                ...
                <Image src={stone2} alt="stone2"
                       className="absolute md:bottom-2 md:left-1/3 bottom-6 max-md:-right-5  z-10"/>
                ...
                <div className="flex lg:justify-around max-w-screen-2xl xl:mx-auto">
                    <div
                        className="h-[535px] xxs:h-[475px] sm:h-[520px] md:h-[550px] lg:h-[500px] xl:h-[475px] 3xl:h-[500px]"></div>
                    <div
                        className="w-full px-6 md:px-0 sm:w-3/4 sm:mx-auto  lg:w-[550px] h-full xl:w-[724px] lg:h-full md:h-2/3 ">
                        <div
                            dir="ltr"
                            className="bg-boardFaq h-full w-full  bg-no-repeat  bg-cover  overflow-hidden relative rounded-xl "
                        >
                            <Image src={tree} alt="tree"
                                   className="absolute right-0 hidden md:block lg:right-2 md:-right-4 xl:-right-4"/>
                            <div
                                className="w-full md:w-11/12 h-full z-10 flex p-5 pb-10 items-start justify-center xl:justify-start"
                                dir="rtl">
                                <FaqAccordion
                    ...
                    <div
                        className="w-full md:w-1/2 md:flex md:items-center md:justify-end lg:w-4/12 px-5  hidden mb-44 ">
                        <div
                            className=" w-full  gap-2 px-2  relative overflow-hidden h-2/3 lg:h-full mt-auto max-w-[260px] ">
                            <Image
                                src={leftWood}
                                alt="wood right"
                            ...
                            <div className="absolute -top-3">
                                <Link href="/faq">
                                    ...
                                    <div
                                        className="absolute z-20 text-xl xxs:text-2xl text-center  left-1/2 -translate-x-1/2 text-white font-bold top-10 text-nowrap cursor-pointer flex items-center gap-2">
                                        <p>{t("FAQ")}</p>
                                        <span className="icon icon-navigate xxs:text-lg"></span>
                                    </div>
                                </Link>
