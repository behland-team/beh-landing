                          ...
                          {characters.map((item, i) => (
                              ...
                              >
                                  <div onClick={()=>openModal(item)}
                                      className="cursor-pointer bg-card bg-no-repeat bg-contain bg-center w-56 xl:w-[280px] xl:h-96 h-80 mx-auto flex justify-center  relative shrink-0 bg-transparent">
