    ...
    return (
        <div className=" flex-col  w-full  bg-[#a7d8d3] pt-10">
            ...
            <div
                ...
                <div className="h-[773px] relative lg:w-3/5 mt-auto overflow-hidden">
                    <div className=" w-full h-full grid grid-cols-1 grid-rows-12 gap-2 px-5 md:px-10  relative">
                        ...
                        {phases[activeTab - 1]?.tasks?.map((item: any, index) => (
                            ...
                            >
                                ...
                                <p className={classNames(item.status ? "text-text-dark_Orange" : "text-text-gray", `text-sm sm:text-base md:text-lg font-semibold `)}>
                                    {item.desc}
