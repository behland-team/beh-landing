  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-wrap justify-between items-center gap-5 mt-4">
        <p className="text-center text-text-gray text-base font-semibold bg-[#FFFFFF99] p-2 rounded-lg ">
          {t("description")}
        </p>
        ...
        <div className="flex items-center justify-center w-full  gap-6 py-5 mx-auto overflow-hidden">
          {visibleImages.map((item, i) => (
            ...
            >
              ...
              <div className=" bg-teamInfoBg bg-no-repeat bg-cover bg-center w-72 h-1/4 overflow-hidden   absolute bottom-0 p-5 flex justify-center items-center flex-col gap-2">
