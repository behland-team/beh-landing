    ...
    <footer dir={"rtl"} className="mb-10">
      <div className="max-w-[75rem] mx-auto bg-[#FEECD8] lg:rounded-xl px-6 py-6 md:px-12 md:py-8 relative">
        <Image
          src={alga}
          alt={"alga"}
          className="max-md:hidden absolute -top-2 left-0"
        />
...
>>>>>>> e33d79e (Revert "Modal")
          ...
          <div className="col-span-full max-sm:col-span-1 md:col-span-1  lg:row-span-1  flex items-center flex-col justify-center gap-2 lg:items-start">
