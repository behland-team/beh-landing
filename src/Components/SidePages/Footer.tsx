            ...
            <div className="max-w-[75rem] mx-auto bg-[#FEECD8] lg:rounded-xl px-6 py-6 md:px-12 md:py-8 relative">
                ...
                <div
                    ...
                    <div className="grid max-sm:col-span-3 col-span-full md:col-span-1 w-full lg:row-span-full ">
                        <div className="flex flex-col items-center justify-around gap-5">
                            ...
                            <ul className="list-disc flex flex-col gap-2 list-inside px-1">
                                <li>
                                    <Link href="/contacts" className="text-sm font-semibold text-text-gray">{t("contactUs")}</Link>
                                </li>
                                <li>
                                    <Link href="/faq" className="text-sm font-semibold text-text-gray">{t("FAQ")}</Link>
                                </li>
                                <li>
                                    <Link href="/about" className="text-sm font-semibold text-text-gray">{t("aboutUs")}</Link>
                                </li>
                                <li>
                                    <Link href="/news" className="text-sm font-semibold text-text-gray">{t("news")}</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div
                        ...
                        <div className="flex max-sm:flex-col justify-start items-start gap-3">
