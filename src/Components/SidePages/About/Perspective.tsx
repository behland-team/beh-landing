...
function Perspective() {
    return (
        <section className="my-20">
            <div className="grid grid-cols-[1fr_1.5fr_1fr] gap-14 justify-items-center max-w-[75rem] mx-auto">
                <div className="space-y-6 px-7 ">
                    <h5 className="text-xl font-bold">ماموریت بهلند:</h5>
                    <div className="grid grid-cols-1 gap-6">
                        <div className="border border-cream-medium bg-cream-light rounded-lg  flex  h-24">
                            <div className="w-1/3 relative">
                                <Image src={badge} alt={"badge"} className="absolute -top-3 right-1"/>
                                <Image src={learning} alt={"icon"} className="absolute -top-1 right-5"/>
                            </div>
                            <p className="w-2/3 text-sm font-semibold px-2 py-4">
                        ...
                        <div className="border border-cream-medium bg-cream-light rounded-lg  flex  h-24">
                            <div className="w-1/3 relative">
                                <Image src={badge} alt={"badge"} className="absolute -top-3 right-1"/>
                                <Image src={coins} alt={"icon"} className="absolute -top-1 right-5"/>
                            </div>
                            <p className="w-2/3 text-sm font-semibold px-2 py-4">
                        ...
                        <div className="border border-cream-medium bg-cream-light rounded-lg  flex  h-24">
                            <div className="w-1/3 relative">
                                <Image src={badge} alt={"badge"} className="absolute -top-3 right-1"/>
                                <Image src={cube} alt={"icon"} className="absolute -top-1 right-5"/>
                            </div>
                            <p className="w-2/3 text-sm font-semibold px-2 py-4">
                        ...
                        <div className="border border-cream-medium bg-cream-light rounded-lg  flex  h-24">
                            <div className="w-1/3 relative">
                                <Image src={badge} alt={"badge"} className="absolute -top-3 right-1"/>
                                <Image src={hand} alt={"icon"} className="absolute -top-1 right-5"/>
                            </div>
                            <p className="w-2/3 text-sm font-semibold px-2 py-4">
                ...
                <div className="bg-storyBg bg-no-repeat w-full h-full relative px-8 py-14">
                    <Image src={crown} alt={"crown"} className="absolute -top-6 left-1/2 -translate-x-1/2"/>
                    <div className="flex flex-col gap-8">
                        <div className="space-y-4">
                            <h4 className="text-center font-bold text-3xl">ماموریت و چشم‌انداز به لند</h4>
                            <h6 className="text-center font-semibold text-lg">ماموریت امروز ما و چشم‌انداز فردا، نقشه
                ...
                <div className="space-y-6 px-7 ">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div className="border border-cream-medium bg-cream-light rounded-lg  flex  h-24">
                            <div className="w-1/3 relative">
                                <Image src={badge} alt={"badge"} className="absolute -top-3 right-1"/>
                                <Image src={www} alt={"icon"} className="absolute -top-1 right-5"/>
                            </div>
                            <p className="w-2/3 text-sm font-semibold px-2 py-4">
                        ...
                        <div className="border border-cream-medium bg-cream-light rounded-lg  flex  h-24">
                            <div className="w-1/3 relative">
                                <Image src={badge} alt={"badge"} className="absolute -top-3 right-1"/>
                                <Image src={balance} alt={"icon"} className="absolute -top-1 right-5"/>
                            </div>
                            <p className="w-2/3 text-sm font-semibold px-2 py-4">
                        ...
                        <div className="border border-cream-medium bg-cream-light rounded-lg  flex  h-24">
                            <div className="w-1/3 relative">
                                <Image src={badge} alt={"badge"} className="absolute -top-3 right-1"/>
                                <Image src={mind} alt={"icon"} className="absolute -top-1 right-5"/>
                            </div>
                            <p className="w-2/3 text-sm font-semibold px-2 py-4">
                        ...
                        <div className="border border-cream-medium bg-cream-light rounded-lg  flex  h-24">
                            <div className="w-1/3 relative">
                                <Image src={badge} alt={"badge"} className="absolute -top-3 right-1"/>
                                <Image src={doc} alt={"icon"} className="absolute -top-1 right-5"/>
                            </div>
                            <p className="w-2/3 text-sm font-semibold px-2 py-4">
