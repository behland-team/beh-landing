...
function Banner() {
  ...
  return (
    <section className="my-10 md:my-20 px-6 md:px-0">
      <div className="border-cream-medium border rounded-3xl mx-auto w-full md:w-4/5 xl:max-w-[75rem] bg-[#FEECD8]  flex flex-col md:flex-row  relative ">
        ...
        <div className="md:w-1/2">
          <Image
            src={bannerImage}
            alt={"about banner"}
            className="mx-auto sm:w-96 lg:w-[530px] xl:absolute xl:-bottom-10 xl:left-2 "
          />
        </div>
