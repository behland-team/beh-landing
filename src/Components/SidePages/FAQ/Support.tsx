    ...
    <section className="my-20">
      <div className="max-w-[75rem] mx-auto flex flex-col lg:flex-row items-center justify-center gap-12 px-12 xl:px-0 ">
        <div className="lg:w-1/3 flex flex-col items-center lg:items-start gap-3">
          ...
          <p className="text-text-gray lg:text-justify text-center">
            {t("description")}
          </p>
          <Link href={"/contacts"}>
            <button className="py-0.5 px-6 mt-4 rounded-lg border bg-[#FEECD8]  w-fit border-cream-medium shadow-main shadow-cream-medium  text-cream-medium flex items-center justify-center gap-2">
