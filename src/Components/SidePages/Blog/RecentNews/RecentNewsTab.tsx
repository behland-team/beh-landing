        ...
        <div className={classNames(className, "")} {...props}>
            <Tabs dir={"rtl"} className="space-y-6" defaultValue={"newest"}>
                ...
                <TabsContent value={"newest"} className="space-y-4">
                    {data.map((item, i) => (
                        <div key={i} className="border border-[#CCCFD4] rounded-lg p-4 grid grid-cols-12 gap-2 md:gap-4">
                            <div className="w-full md:min-h-28 md:min-w-28 rounded-lg bg-sky-700 col-span-4 md:col-span-3 lg:col-span-4 xl:col-span-3 row-span-2"></div>
                            <div className="flex flex-col gap-3 col-span-8 md:col-span-9 lg:col-span-8 xl:col-span-9 pb-4 xl:border-b border-dashed ">
                                <div className="space-y-2">
                                    <h3 className="text-sm font-bold max-xxs:text-xs">بهلند مسیر یادگیری جدیدی ارائه داد است ؟</h3>
                                    <p className="text-xs tracking-tight text-justify"> لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
                                        از
                                        صنعت چاپ و با استفاده از طراحان گرافیک است ...</p>
                                </div>
                            </div>
                            <div className="flex items-center justify-between col-span-full xl:col-span-9  xl:col-start-4">
