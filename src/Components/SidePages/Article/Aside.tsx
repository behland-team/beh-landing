...
function Aside({className, ...props} : ComponentProps<"aside">) {
    return (
        <aside className={classNames("space-y-5 sticky top-32 h-fit" ,className)} {...props}>
            <div className="border border-cream-medium bg-[#FEECD8] px-4 py-10 relative rounded-xl">
                <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-64 max-w-64">
                    ...
                    <p className="absolute top-2 left-1/2 -translate-x-1/2 w-full text-center font-bold">در این مقاله میخوانید : </p>
                </div>
            ...
            <Share />
            <div className="h-56 flex items-center justify-center bg-cream-light rounded-lg">
