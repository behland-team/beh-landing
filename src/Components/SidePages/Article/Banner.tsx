...
function Banner() {
    return (
        <section className=" bg-[#FBF7F5]">
            <div className="space-y-10 3xl:max-w-[75rem] mx-auto max-3xl:px-20 pt-5 pb-20">
                <div className="font-light">{"بهلند > طراحی سایت > تبلیغات در اینستاگرام"}</div>
                <div className="flex gap-14  justify-between">
                    <div className="space-y-8 w-1/2">
                        <div className="flex items-center gap-2">
                                <span
                                    className="size-10 border-cream-medium border text-cream-medium bg-cream-dark_light rounded-full flex items-center justify-center p-1">
                                    <span className="icon icon-share"></span>
                                </span>
                            <ul className="flex items-center gap-2 list-disc text-cream-medium list-inside marker:text-cream-medium">
                        ...
                        <div className="flex flex-col gap-3">
                            <h1 className="text-2xl font-semibold">بهلند یک مسیر آموزشی جدید برای کاربرانش راه‌اندازی
                                کرد</h1>
                            <p className="tracking-tight text-justify text-text-gray">کاربران می‌توانند با مأموریت‌ها، تمرین‌ها و
                    ...
                    <div
                        className="w-1/2 rounded-2xl border border-cream-medium bg-[#FEECD8] flex items-center justify-center">
