        ...
        <div className="space-y-10 my-5">
            <div
                ...
                <div className="absolute -top-2 right-6 w-64 max-md:hidden">
                    ...
                    <h3 className="w-full text-center left-1/2 -translate-x-1/2 top-2 absolute font-bold">دیدگاه همراهان
                        ما </h3>
                </div>
                <div>
                    <h3 className="font-bold md:hidden"> دیدگاه همراهان ما </h3>
                </div>
                <div
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                className="block border border-[#8C8C8C] text-[#8C8C8C] px-4  py-2 rounded-lg font-semibold mr-auto">پاسخ
                                دادن
                            </button>
                        </div>
                    </div>
            ...
            <div className="border border-[#CCCFD4] bg-[#FBF7F5] px-6 pb-8 pt-20 relative rounded-xl">
                ...
                <form className="grid grid-cols-2 gap-6">
                    <p className="col-span-full text-sm font-semibold text-text-gray">نشانی ایمیل شما منتشر نخواهد
                        شد.</p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6  sm:gap-2 col-span-full">
                        <div className="flex items-center gap-2">
                            <input id="rememberMe" type="checkbox"/>
                            <label htmlFor="rememberMe" className="text-sm text-[#404040]">ذخیره نام ،ایمیل و وبسایت من
                                در مرورگر برای که دورباره دیدگاهی مینویسم.</label>
                        </div>
                        <button
                            className="max-sm:w-full px-6 py-2 rounded-lg border-2 text-nowrap text-sm lg:text-base border-cream-medium text-cream-medium bg-[#FEECD8] shadow-main shadow-cream-medium font-semibold">ارسال
                            دیدگاه
                        </button>
                    </div>
                </form>
