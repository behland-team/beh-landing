...
function MobileNav({open, setOpen}: MobileNavInterface) {
    ...
    return (
        <>
            <div onClick={()=>setOpen(false)} className="md:hidden h-screen w-full bg-black/50  fixed top-0 right-0 z-40">
            </div>
            <div className="md:hidden h-screen w-4/5 bg-cream-light  fixed top-0 right-0  flex flex-col justify-between px-6 py-10 z-50">
