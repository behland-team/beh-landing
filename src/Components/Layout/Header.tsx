...
export default function Header() {
    ...
    return (
        <header
            className=" pt-[18px] pb-[14px] lg:py-0 h-24  md:h-[10dvh]  lg:h-[12dvh]  bg-cream-light">
            <div className="flex  w-full  justify-center items-center h-full xl:max-w-screen-2xl xl:mx-auto max-w-[440px] md:max-w-full mx-auto">
                <nav
                    dir="rtl"
